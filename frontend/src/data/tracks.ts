...
const tracks: Track[] = [
  ...
  },
  {
    ...
    priceINR: "149900",
    priceELSE: "2000",
    description: "Go beneath the syntax and understand how JavaScript actually works — prototype inheritance, the V8 engine and hidden classes, and the event loop that keeps everything responsive. This course builds the mental models that separate engineers who use JavaScript from engineers who understand it.",
    trailer: "https://firebasestorage.googleapis.com/v0/b/topdev-93530.appspot.com/o/Website%20utils%2Ftrail.mp4?alt=media&token=b7256e18-ce75-4272-ad6b-103770c02645",
    image: "https://res.cloudinary.com/practicaldev/image/fetch/s--e_rqeB7o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2400/1%2AFPtQLT2Zk-baHficCz_mXQ.png",
    theme: "text-yellow-400",
    theme2: "bg-yellow-600 hover:bg-yellow-500",
    border: "border-yellow-500",
    launched: false,
    courseContent: [
      { name: "Chapter 4 - Objects & Inheritance", subchapters: [{ name: "4.1 - Prototype Inheritance", src: "" }] },
      { name: "Chapter 5 - Inside the Engine", subchapters: [{ name: "5.1 - V8 Engine and Hidden Classes", src: "" }] },
      { name: "Chapter 6 - Concurrency", subchapters: [{ name: "6.1 - The Event Loop and Microtasks", src: "" }] },
    ],
    modules: [
      { title: "Prototype Inheritance", description: "How objects delegate to their prototype, and why it's delegation not copying." },
      { title: "V8 Hidden Classes", description: "How V8 optimizes property access and how to avoid deopts." },
      { title: "The Event Loop", description: "Tasks vs microtasks, and why a resolved Promise beats setTimeout(0)." },
    ],
    learnings: ["The prototype chain and property lookup", "Hidden classes and V8 optimization", "Tasks vs microtasks", "Why await is just .then under the hood"],
  },
  {
    id: 10,
    title: "Web APIs and Real-Time",
    priceINR: "149900",
    priceELSE: "2000",
    description: "Learn how the web moves data in real time. Start at the HTTP/WebSocket boundary — the Upgrade handshake — and understand when to reach for long-polling versus a full-duplex WebSocket connection, and what each one really costs.",
    trailer: "https://firebasestorage.googleapis.com/v0/b/topdev-93530.appspot.com/o/Website%20utils%2Ftrail.mp4?alt=media&token=b7256e18-ce75-4272-ad6b-103770c02645",
    image: "https://res.cloudinary.com/practicaldev/image/fetch/s--e_rqeB7o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2400/1%2AFPtQLT2Zk-baHficCz_mXQ.png",
    theme: "text-cyan-400",
    theme2: "bg-cyan-700 hover:bg-cyan-500",
    border: "border-cyan-500",
    launched: false,
    courseContent: [
      { name: "Chapter 2 - The WebSocket Boundary", subchapters: [{ name: "2.2 - WebSocket Handshake", src: "" }] },
      { name: "Chapter 3 - Choosing a Transport", subchapters: [{ name: "3.1 - Long-Polling vs WebSockets", src: "" }] },
    ],
    modules: [
      { title: "The Upgrade Handshake", description: "How an HTTP request becomes a WebSocket connection." },
      { title: "Long-Polling vs WebSockets", description: "The real cost of each transport and when to use which." },
    ],
    learnings: ["The HTTP Upgrade handshake", "Full-duplex framing", "Long-polling trade-offs", "Choosing the right real-time transport"],
  },
  {
    id: 11,
    ...
    priceINR: "149900",
    priceELSE: "2000",
    description: "Make React fast on purpose. Understand what actually triggers re-renders, how memoization and computed state cut wasted work, and how React.memo, useCallback, and useMemo fit together — including the reference-equality traps that quietly defeat them.",
    trailer: "https://firebasestorage.googleapis.com/v0/b/topdev-93530.appspot.com/o/Website%20utils%2Ftrail.mp4?alt=media&token=b7256e18-ce75-4272-ad6b-103770c02645",
    image: "https://res.cloudinary.com/practicaldev/image/fetch/s--e_rqeB7o--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://cdn-images-1.medium.com/max/2400/1%2AFPtQLT2Zk-baHficCz_mXQ.png",
    theme: "text-sky-400",
    theme2: "bg-sky-700 hover:bg-sky-500",
    ...
    launched: false,
    courseContent: [
      { name: "Chapter 3 - Cutting Wasted Work", subchapters: [{ name: "3.2 - Memoization and Computed State", src: "" }] },
      { name: "Chapter 4 - Stable References", subchapters: [{ name: "4.1 - React.memo and useCallback", src: "" }] },
    ],
    modules: [
      { title: "Memoization & Computed State", description: "Recompute only when dependencies change." },
      { title: "React.memo & useCallback", description: "Skip re-renders by keeping props referentially stable." },
    ],
    learnings: ["What triggers a re-render", "Shallow equality and reference traps", "When React.memo actually helps", "useCallback vs useMemo"],
  },
];
